                        ...
                        <v-card>
                            <v-card-title primary-title>
                                <div>
                                    ...
                                    <strong><em>This will ignore the "Author" filter.</em></strong>
                                </div>
                            </v-card-title>
                            ...
                            <div v-if="!topListLoading">
                                <top-list :items="top">
                                    <template slot-scope="listItemScope">
                                        <div class="guage-content" v-on:click="filterByAuthor(listItemScope.item.author);">
                    ...
                    <v-flex xs12 md9 class="pr-4" row wrap>
                        ...
                        <v-flex xs12 md6>
                            <v-card class="mb-3 mr-3">
                                <v-card-title primary-title>
                                    <div>
                                        <h3 class="headline mb-0">Tweets By Category</h3>
                                        <span>Try filtering globally to see more specific graphs.</span>
                                    </div>
                                </v-card-title>
    ...
    export default {
        ...
        methods: {
            ...
            loadCategoryTotals(){
                ...
                this.$store.dispatch('tweets/categoryTotals')
                    .then(function () {
            ...
            filterByAuthor(author){
                let thisComponent = this;
                this.$store.commit('filter/setAuthorFilter', author);
        ...
        computed: {
            ...
            categoryTotalsForChart: function(){
                return this.$store.getters['tweets/getCategoryTotalsForChart'];
            },
            categoryTotals: function(){
                return this.$store.getters['tweets/getCategoryTotals'];
            },
            categoryTotal: function(){
                return this.$store.getters['tweets/getCategoryTotal'];
            },
